...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>ISITOTO | Pusat Login Aman & Arena Bermain Nyaman</title>
        ...
        <meta property="og:title" content="ISITOTO | Pusat Login Aman & Arena Bermain Nyaman" />
        ...
        <meta name="twitter:title" content="ISITOTO | Pusat Login Aman & Arena Bermain Nyaman" />
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>ISITOTO | Pusat Login Aman & Arena Bermain Nyaman</h1>
          <p className="ld">ISITOTO adalah platform terpercaya dengan akses super cepat, keamanan tingkat tinggi, dan link alternatif yang selalu aktif 24 jam. Daftar gratis sekarang.</p>
          <div className="hb">
        ...
        <section className="sec" id="tentang"><div className="C">
          ...
          <div className="art">
            <p>ISITOTO di situs resmi ISITOTO hadir dengan performa maksimal untuk pengalaman digital yang powerful. Layaknya latihan fitness yang intens dan terukur, setiap fitur ISITOTO dirancang untuk memberikan hasil optimal. Server berperforma tinggi memastikan loading super cepat, sementara sistem keamanan berlapis menjaga setiap data pengguna tetap aman dan terlindungi.</p>
            <p>Raih akses premium ISITOTO melalui situs resmi ISITOTO dan rasakan kekuatan platform digital yang sesungguhnya. Dengan uptime 99,9%, enkripsi SSL 256-bit, dan dukungan multi-device, ISITOTO adalah pilihan champion untuk akses digital yang handal. Link alternatif resmi selalu aktif, dan tim support 24/7 siap membantu Anda mencapai performa terbaik dalam setiap akses.</p>
          </div>
        </div></section>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=720&h=280&fit=crop" alt="ISITOTO - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=720&h=280&fit=crop" alt="ISITOTO - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=720&h=280&fit=crop" alt="ISITOTO - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
